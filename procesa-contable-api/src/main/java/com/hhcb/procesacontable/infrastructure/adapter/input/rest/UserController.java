...
import com.hhcb.procesacontable.infrastructure.adapter.input.rest.dto.response.UserResponse;
...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<List<UserResponse>>> findAll() {
        List<UserResponse> response = userPort.findAll().stream().map(
    ...
    public ResponseEntity<ApiResponse<Void>> delete(@PathVariable String id) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.empty());
    }
}
